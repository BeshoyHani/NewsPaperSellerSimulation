...
namespace SimulationCore
{
    public class Server
    {
        ...
        public Server(SimulationSystem simulationSystem)
        {
        ...
        private void FillDayTypeDistribution()
        {
            ...
            DTD[0].MinRange = 1;
            DTD[0].MaxRange = Convert.ToInt32(DTD[0].Probability * 100);
            ...
            for(int i=1; i<DTD.Count; i++)
            {
                ...
                DTD[i].MaxRange = Convert.ToInt32(DTD[i].Probability * 100);
            }
        ...
        private void FillDemandDistribution()
        {
            ...
            for(int i=0; i<3; i++)
            {
                DD[0].DayTypeDistributions[i].CummProbability = DD[i].DayTypeDistributions[0].Probability;
                DD[0].DayTypeDistributions[i].MinRange = 1;
                DD[0].DayTypeDistributions[i].MaxRange = Convert.ToInt32(DD[0].DayTypeDistributions[i].Probability * 100);
                ...
                for (int j=1; j<DD.Count; j++)
                {
                    ...
                    DD[j].DayTypeDistributions[i].MaxRange = Convert.ToInt32(DD[j].DayTypeDistributions[i].Probability * 100);
                }
            }
